...
def add_input_logic(self,path,zk,input_lock):
    ...
    try:
        ...
        #     print('asd')
        for item in data:
            # zk.ensure_path("/inputs/",sequence=True,item.encode(encoding='utf-8'))
    except:
        pass


def main(self,i,zk,input_lock):
    if i == "status":
    ...
    if i == "add":
        ...
        path = input()
        self.add_input_logic(path,zk,input_lock)     
    else:
        print('invalid input')
